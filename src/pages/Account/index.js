                    ...
                    <>
                        ...
                        <View style={{
                            ...
                            <View style={{ padding: 10, }}>
                                ...
                                <MyList label="LOB" value={user.lob} />
                                <MyList label="TDH" value={user.tsh} />
                                <MyList label="Username" value={user.username} />

                                <MyList label="Nama Lengkap / Store Leader" value={user.nama_lengkap} />

                                <MyList label="Area" value={user.area} />
